...
class UpdateUsageStatsForegroundServiceUseCaseTest {
    ...
    @Test
    fun updateUsageStatsForegroundServiceUseCase_requestPermission() = runTest {
        ...
        assertEquals(
            ...
            actual = updateUsageStatsForegroundServiceUseCase(),
        )
    }

    @Test
    fun updateUsageStatsForegroundServiceUseCase_start() = runTest {
    ...
    @Test
    fun updateUsageStatsForegroundServiceUseCase_stop() = runTest {
