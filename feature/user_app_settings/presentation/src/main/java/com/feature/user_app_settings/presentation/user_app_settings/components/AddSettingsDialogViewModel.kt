...
class AddSettingsDialogViewModel @Inject constructor(
    private val repository: com.feature.user_app_settings.domain.repository.UserAppSettingsRepository,
    private val addSettingsUseCases: com.feature.user_app_settings.domain.use_case.add_settings.AddSettingsUseCases
) : ViewModel() {
            ...
            is AddSettingsDialogEvent.AddSettings -> {
                ...
                viewModelScope.launch {
                    val settingsType = when (_state.value.selectedRadioOptionIndex) {
                        0 -> com.feature.user_app_settings.domain.model.SettingsType.SYSTEM

                        1 -> com.feature.user_app_settings.domain.model.SettingsType.SECURE

                        2 -> com.feature.user_app_settings.domain.model.SettingsType.GLOBAL

                        else -> com.feature.user_app_settings.domain.model.SettingsType.SYSTEM
                    }

                    repository.upsertUserAppSettings(
                        com.feature.user_app_settings.domain.model.UserAppSettingsItem(
                            enabled = true,
